...
if($layoutsite === 'boxed'){
    $doc->addStylesheet($template_folder.'/business_css/boxed-reset.css','text/css');
    $doc->addStylesheet($template_folder.'/css/boxed-style.css','text/css');
    $doc->addStylesheet($template_folder.'/business_css/boxed-style.css','text/css');
}else{
    $doc->addStylesheet($template_folder.'/business_css/reset.css','text/css');
    $doc->addStylesheet($template_folder.'/css/style.css','text/css');
    $doc->addStylesheet($template_folder.'/business_css/style.css','text/css');
}
...
if($layoutsite === 'boxed'){
    ...
    $doc->addStylesheet($template_folder.'/css/boxed-stickytwo.css','text/css');
}else{
    $doc->addStylesheet($template_folder.'/css/responsive-leyouts.css','text/css');
    $doc->addStylesheet($template_folder.'/business_js/mainmenu/stickytwo.css','text/css');
}
$doc->addStylesheet($template_folder.'/business_js/mainmenu/bootstrap.min.css','text/css');
//$doc->addStylesheet($template_folder.'/business_js/mainmenu/sticky.css','text/css');
$doc->addStylesheet($template_folder.'/business_js/mainmenu/demo.css','text/css');
$doc->addStylesheet($template_folder.'/business_js/mainmenu/menu.css','text/css');
