...
$classes = "k2itemview onepage_blog";
    ...
    <?php if($item): ?> 
        <?php if(!empty($imagesize)) :?>
            ...
            <!-- <a href="<?php echo ElementParser::getK2ItemLink($item->id,$item->alias,$item->catid,$item->category->alias);?>"> -->
                <img class="wres" src="<?php echo $item->{$imagesize}; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
            <!-- </a> -->
            <?php endif; ?>
        <?php endif;?>
        <?php 
        ...
        <!--<?php if($posttype === '1') :?>
            ...
            <?php if($showcreated === '1') : ?>
                ...
                <a href="#" class="post-date"><i class="fa fa-file-text"></i> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></a> 
                <?php //endif; ?>
            <?php endif; ?>
            ...
            <?php if($showcomment === '1') : ?>
                <?php //if($item->params->get('itemCommentsAnchor') && ($item->params->get('comments') == '1') ): ?>
                        ...
                        <a href="<?php echo $item->link; ?>#itemCommentsAnchor">
                            <i class="fa fa-comment"></i>  <?php echo $item->numOfComments; ?> <?php echo ($item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
                        </a>
                        <?php else: ?>
                        <a href="<?php echo $item->link; ?>#itemCommentsAnchor">
