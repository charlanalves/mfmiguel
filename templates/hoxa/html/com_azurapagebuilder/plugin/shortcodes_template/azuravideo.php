...
<?php else: ?>
    <iframe <?php echo $classes;?> src="<?php echo $src;?>?autoplay=<?php echo $autoplay;?>&amp;loop=<?php echo $loop;?>" width="<?php echo $width;?>" height="<?php echo $height;?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
<?php endif;?>