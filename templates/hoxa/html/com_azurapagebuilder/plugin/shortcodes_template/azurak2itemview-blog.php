    ...
    <?php if($item): ?> 
        ...
        <!--<?php if($posttype === '1') :?>
            ...
            <?php if($showcreated === '1') : ?>
                ...
                <a href="#" class="post-date"><?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC2')); ?></a> 
                <?php //endif; ?>
            <?php endif; ?>
            ...
            <br />
            <a href="<?php echo ElementParser::getK2ItemLink($item->id,$item->alias,$item->catid,$item->category->alias);?>" class="lfour"><i class="fa fa-chevron-circle-right"></i>&nbsp; <?php echo JText::_('TPL_HOXA_READ_MORE2_TEXT');?></a>
            <?php endif;?>
        <!-- </div> -->
