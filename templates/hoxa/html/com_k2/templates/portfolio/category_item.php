...
<div class="post">
	...
	<div class="post-title">
		<?php if ($this->item->params->get('catItemTitleLinked')): ?>
			<h2>
			<a href="<?php echo $this->item->link; ?>"><?php echo preg_replace('/--([^-]*)--/', '$1', $this->item->title);?></a>
			</h2>
		...
		<div class="post-meta">
			<h6><?php if($this->item->params->get('catItemAuthor')): ?>
				...
				<?php if($this->item->params->get('catItemCategory')): ?>
					<!-- Item category name --> 
					 / <a href="<?php echo $this->item->category->link; ?>"><?php echo preg_replace('/--([^-]*)--/', '$1', $this->item->category->name);?></a>
				<?php endif; ?>
			</h6>							
		</div>
	</div>				
