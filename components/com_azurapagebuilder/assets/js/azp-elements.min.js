   ...
   function azura_contactAJAX() {
        jQuery('.azura_contactform').each(function(index){
            ...
            $contact.find('#azuracontactform').submit(function(){
                ...
                if(name == ''){
                    $contact.find('#azuramessage').html('Informe seu nome.');
                ...
                if(email == ''){
                    $contact.find('#azuramessage').html('Informe seu email.');
                    $contact.find('#azuramessage').slideDown(300);
                    $contact.find('#email').focus();
                    return false;
                }
				if(website == ''){
					$contact.find('#azuramessage').html('Informe seu telefone.');
					$contact.find('#azuramessage').slideDown(300);
					$contact.find('#website').focus();
					return false;
				}
                if(message == ''){
