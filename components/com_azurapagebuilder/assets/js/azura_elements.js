   ...
   function azura_contactAJAX() {
        jQuery('.azura_contactform').each(function(index){
            ...
            $contact.find('#azuracontactform').submit(function(){
                ...
                if(name == ''){
                    $contact.find('#azuramessage').html('Informe seu nome por gentileza.');
                ...
                if(email == ''){
                    $contact.find('#azuramessage').html('Informe seu email por gentileza.');
                    $contact.find('#azuramessage').slideDown(300);
                ...
                if(message == ''){
                    $contact.find('#azuramessage').html('Informe a mensagem.');
                    $contact.find('#azuramessage').slideDown(300);
